...
rispetto alle unità. In tal modo si ottiene il seguente risultato:
\begin{align*}
	\begin{array}{l}
...
\begin{align}
    ...
    \end{array}
\end{align}
In questo caso, a differenza del modello nella versione precedente (\ref{eq:mipqaplin}), le variabili della funzione obiettivo $y_{ij}$ sono 
