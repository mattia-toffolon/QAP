...
formulazione dei problemi di programmazione lineare intera (\ref{eq:mip}). Ai fini della risoluzione del problema, è necessario 
ricondurre il modello in oggetto alla formulazione \textit{MIP} apportando le modifiche necessarie.

Nello specifico il problema risiede nella funzione obiettivo. Come lascia intuire il nome, la programmazione lineare intera esige 
un funzione obiettivo lineare, mentre nel modello in questione è presente un prodotto fra incognite.
