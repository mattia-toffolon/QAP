...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{\textwidth}
     ...
     \begin{subfigure}[b]{\textwidth}
        ...
        \end{subfigure}
     \end{subfigure}
     \caption{ISoluzioni delle istanze Tai16c a densità 30\%, 50\% e 80\%}
     \vspace*{1.5cm}
     \begin{subfigure}[b]{\textwidth}
        \centering
        \begin{subfigure}[b]{0.20\textwidth}
        ...
        \end{subfigure}
     \end{subfigure}
     \caption{ISoluzioni delle istanze Tai25c a densità 10\%, 40\% e 90\%}
\end{figure}
...
\newpage
Le caselle nere sono spaziate fra loro quindi -> A prova di validità del metodo di generazione di istanze Tai*c...
